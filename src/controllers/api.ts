 ...
 */
export async function getFoursquare(req, res, next) {
 ...
 * Last.fm API example.
 */
export async function getLastfm(req, res, next) {
 ...
 * Twitter API example.
 */
export async function getTwitter(req, res, next) {
 ...
 * Steam API example.
 */
export async function getSteam(req, res, next) {
