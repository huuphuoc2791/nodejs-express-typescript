...
import * as passportLinkedinOauth2 from 'passport-linkedin-oauth2';
...
const {Strategy: InstagramStrategy} = passportInstagram;
const {Strategy: LocalStrategy} = passportLocal;
const {Strategy: FacebookStrategy} = passportFacebook;
const {Strategy: TwitterStrategy} = passportTwitter;
const {Strategy: GitHubStrategy} = passportGithub;
const {Strategy: LinkedInStrategy} = passportLinkedinOauth2;
const {Strategy: OpenIDStrategy} = passportOpenid;
const {OAuthStrategy} = passportOauth;
